...
# Usar o silhuetscore para definir o melhor numero de clusters
...
# dbscan = DBSCAN()
# dbscan.fit(X)
# y_label = pd.DataFrame(dbscan.labels_)
# df_dbscanCluster = pd.concat([X, y_label], axis=1)
# print('\nMean\n')
# df_dbscanCluster.groupby(by=0).mean()
# print('\nStd\n')
# df_dbscanCluster.groupby(by=0).std()
# print('\nCount\n')
# df_dbscanCluster.iloc[:, -1].value_counts()
